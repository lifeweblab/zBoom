...
$args = array(
	...
	'menu_title'                => esc_html__( 'Build Options', 'your-textdomain-here' ),

	// The text to appear on the page title.
	'page_title'                => esc_html__( 'Build Option', 'your-textdomain-here' ),
...
Redux::set_section(
	...
	array(
		...
		'id'               => 'basic',
		'desc'             => esc_html__( 'Options for Header', 'your-textdomain-here' ),
